<template>
  <div class="hello">
    ...
    <a
      href="https://github.com/michael-spengler/toiletpaper.exchange"
      target="_blank"
    ...
    German Bird calling for Klopapier (= toilet paper)
    <p><br /></p>
    ...
    <a
      href="https://github.com/michael-spengler/toiletpaper.exchange/pulls"
      target="_blank"
      rel="noopener"
      >pull request</a
    >
